...
})(["position:relative;.count{display:block;position:relative;transition:all 0.35s;backface-visibility:hidden;}.count-enter{transform:scale(4) rotateX(0.5turn);}.count-enter-active{transform:rotateX(0);}.count-exit{top:0;position:absolute;transform:rotateX(0);}.count-exit-active{transform:scale(4) rotateX(0.5turn);}"]); //Cart counter animation. Doubles the dot when the counter increments for 4 seconds before going to the new value
...
//# sourceMappingURL=_app.js.5d6172c83a420f1a1b89.hot-update.js.map